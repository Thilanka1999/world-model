...
class PWCDecoder(nn.Module):
    ...
    def __init__(self, enc_dims, md=4):
        ...
        self.dc_conv1 = conv(
            dd[4] + 2, 128, kernel_size=3, stride=1, padding=1, dilation=1
        )
    ...
    def forward(self, feature_list_1, feature_list_2, img_hw):
        ...
        c11 = feature_list_1["l1"]
        c12 = feature_list_1["l2"]
        c13 = feature_list_1["l3"]
        c14 = feature_list_1["l4"]
        c15 = feature_list_1["l5"]
        c16 = feature_list_1["l6"]

        c21 = feature_list_2["l1"]
        c22 = feature_list_2["l2"]
        c23 = feature_list_2["l3"]
        c24 = feature_list_2["l4"]
        c25 = feature_list_2["l5"]
        c26 = feature_list_2["l6"]
        ...
        x = self.dc_conv4(
            self.dc_conv3(self.dc_conv2(self.dc_conv1(torch.cat([flow2, x4], 1))))
        )
